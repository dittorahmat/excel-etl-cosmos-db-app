...
describe('API Key Routes', () => {
    let app;
    let mockCreateApiKey;
    let mockListApiKeys;
    let mockRevokeApiKey;
    ...
    beforeEach(() => {
        ...
        const mockRepo = new ApiKeyRepository({});
        mockCreateApiKey = mockRepo.createApiKey;
        mockListApiKeys = mockRepo.listApiKeys;
        mockRevokeApiKey = mockRepo.revokeApiKey;
    });
    ...
    describe('Authentication', () => {
        it('should require authentication for all routes', async () => {
            ...
            for (const route of routes) {
                const response = await request(unauthApp)[route.method](route.path);
