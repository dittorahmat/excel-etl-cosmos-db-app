...
describe('Data Endpoint', () => {
    ...
    describe('GET /api/data', () => {
        ...
        it('should filter by date range', async () => {
            ...
            const next = mockNext();
            await app._router.handle(req, res, next);
            expect(mockCosmosDb.queryRecords).toHaveBeenCalledWith(expect.stringContaining('WHERE'), expect.arrayContaining([
        ...
        it('should filter by category', async () => {
            ...
            const next = mockNext();
            await app._router.handle(req, res, next);
            expect(mockCosmosDb.queryRecords).toHaveBeenCalledWith(expect.stringContaining('LOWER(c.category) = LOWER(@category0)'), expect.arrayContaining([
