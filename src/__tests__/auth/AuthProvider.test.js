...
const TestComponent = () => (_jsx("div", { children: _jsx("div", { "data-testid": "auth-status", children: "Test Component" }) }));
describe('AuthProvider', () => {
    ...
    it('should render children', async () => {
        ...
        render(_jsx(MsalProvider, { instance: mockMsalInstance, children: _jsx(AuthProvider, { children: _jsx("div", { "data-testid": "test-child", children: "Test Child" }) }) }));
        expect(screen.getByTestId('test-child')).toBeInTheDocument();
    });
    it('should initialize without errors', async () => {
        // Simple test to check if AuthProvider initializes without throwing
        expect(() => {
            render(_jsx(MsalProvider, { instance: mockMsalInstance, children: _jsx(AuthProvider, { children: _jsx(TestComponent, {}) }) }));
        }).not.toThrow();
    });
