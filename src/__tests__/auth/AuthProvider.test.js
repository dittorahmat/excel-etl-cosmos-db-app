...
const TestComponent = () => {
    ...
    return (_jsxs("div", { children: [_jsx("div", { "data-testid": "auth-status", children: isAuthenticated ? 'Authenticated' : 'Not Authenticated' }), _jsx("button", { onClick: login, "data-testid": "login-button", children: "Login" }), _jsx("button", { onClick: logout, "data-testid": "logout-button", children: "Logout" })] }));
};
describe('AuthProvider', () => {
    ...
    it('should render children', () => {
        render(_jsx(AuthProvider, { children: _jsx("div", { "data-testid": "test-child", children: "Test Child" }) }));
