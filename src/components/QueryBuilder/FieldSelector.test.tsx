...
describe('FieldSelector', () => {
  ...
  it('renders with no fields selected', () => {
    render(<FieldSelector fields={fields} selectedFields={[]} onFieldsChange={() => {}} />);
    expect(screen.getByText('Select fields to display...')).toBeInTheDocument();
  });

  it('renders with a selected field', () => {
    render(<FieldSelector fields={fields} selectedFields={['field1']} onFieldsChange={() => {}} />);
  ...
  it('allows selecting a field', async () => {
    ...
    render(<FieldSelector fields={fields} selectedFields={[]} onFieldsChange={onFieldsChange} />);
  ...
  it('allows deselecting a field', async () => {
    const user = userEvent.setup();
    const onFieldsChange = vi.fn();
    render(<FieldSelector fields={fields} selectedFields={['field1', 'field2']} onFieldsChange={onFieldsChange} />);
