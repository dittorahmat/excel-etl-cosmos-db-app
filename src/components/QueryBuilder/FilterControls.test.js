...
describe('FilterControls', () => {
    it('renders with no filters', () => {
        render(_jsx(FilterControls, { fields: fields, filters: [], onFiltersChange: () => { }, onAddFilter: () => { }, onRemoveFilter: () => { }, defaultShowFilters: true }));
    ...
    it('adds a new filter', async () => {
        ...
        render(_jsx(FilterControls, { fields: fields, filters: [], onFiltersChange: () => { }, onAddFilter: onAddFilter, onRemoveFilter: () => { }, defaultShowFilters: true }));
    ...
    it('removes a filter', async () => {
        ...
        render(_jsx(FilterControls, { fields: fields, filters: filters, onFiltersChange: () => { }, onAddFilter: () => { }, onRemoveFilter: onRemoveFilter, defaultShowFilters: true }));
    ...
    it('changes a filters field, operator, and value', async () => {
        ...
        const { rerender } = render(_jsx(FilterControls, { fields: fields, filters: filters, onFiltersChange: onFiltersChange, onAddFilter: () => { }, onRemoveFilter: () => { }, defaultShowFilters: true }));
        // Change field
        ...
        rerender(_jsx(FilterControls, { fields: fields, filters: updatedFilters, onFiltersChange: onFiltersChange, onAddFilter: () => { }, onRemoveFilter: () => { }, defaultShowFilters: true }));
        // Change operator
        ...
        rerender(_jsx(FilterControls, { fields: fields, filters: filtersWithOperator, onFiltersChange: onFiltersChange, onAddFilter: () => { }, onRemoveFilter: () => { }, defaultShowFilters: true }));
        // Change value
