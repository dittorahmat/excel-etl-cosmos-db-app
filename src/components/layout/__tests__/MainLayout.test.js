...
vi.mock('../Navbar', () => ({
    Navbar: vi.fn(() => _jsx("div", { children: "Mock Navbar" })),
}));
vi.mock('../Sidebar', () => ({
    Sidebar: vi.fn(() => _jsx("div", { children: "Mock Sidebar" })),
}));
vi.mock('../../common/ErrorBoundary', () => ({
    ErrorBoundary: vi.fn(({ children }) => _jsx("div", { children: children })),
}));
describe('MainLayout', () => {
    beforeEach(() => {
        vi.clearAllMocks();
    ...
    it('renders Navbar, Sidebar, and children correctly', () => {
        const testChildren = _jsx("div", { "data-testid": "test-children", children: "Test Children Content" });
        render(_jsx(MainLayout, { children: testChildren }));
    ...
    it('renders with the correct layout classes', () => {
        const { container } = render(_jsx(MainLayout, { children: _jsx("div", { children: "Children" }) }));
        // The outermost div rendered by MainLayout (after ErrorBoundary mock)
        const mainLayoutDiv = container.firstChild?.firstChild;
    ...
    it('wraps content with ErrorBoundary', () => {
        render(_jsx(MainLayout, { children: _jsx("div", { children: "Children" }) }));
