...
const customRender = (ui, options = {}) => {
    ...
    initialEntries = ['/'], wrapper: WrapperComponent, 
    // userEventOptions is destructured but not used, keeping for API compatibility
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    userEventOptions = {}, ...renderOptions } = options;
    ...
    const DefaultWrapper = ({ children, initialEntries }) => (_jsx(MsalProvider, { instance: mockMsalInstance, children: _jsx(MemoryRouter, { initialEntries: initialEntries, children: _jsx(AllTheProviders, { children: children }) }) }));
