...
if [ -f "/home/iesr/excel-etl-cosmos-db-app/certs/live/iesr.indonesiacentral.cloudapp.azure.com/fullchain.pem" ]; then
    echo "✓ Local certificate files exist"
    # Check certificate details
    openssl x509 -in /home/iesr/excel-etl-cosmos-db-app/certs/live/iesr.indonesiacentral.cloudapp.azure.com/fullchain.pem -noout -dates 2>/dev/null || echo "⚠️  Cannot read certificate dates"
else
...
echo "  1. Ensure iesr.indonesiacentral.cloudapp.azure.com points to this server"
